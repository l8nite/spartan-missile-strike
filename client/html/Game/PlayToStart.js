...
function PlayToStart(Imports) {
	...
	var playImage = $("<img></img>")
			.attr("src", "../shared/images/spartanStrike_play.png")
	...
	$("#" + Imports.domId["PlayToStart"]).css("background-image", "url(\"../shared/images/longBG_smaller.jpg\")")
		.css("background-size", "100%")
		.append($("<img></img>")
			.attr("src", "../shared/images/spartanStrike_title.png")
			.css("position", "absolute")
		...
		.append($("<img></img>")
			.attr("src", "../shared/images/spartanStrike_upperRedline.png")
			.css("position", "absolute")
		...
		.append($("<img></img>")
			.attr("src", "../shared/images/spartanStrike_mainIcon.png")
			.css("position", "absolute")
		...
		.append(playImage)
		.append($("<img></img>")
			.attr("src", "../shared/images/spartanStrike_lowerRedline.png")
			.css("position", "absolute")
