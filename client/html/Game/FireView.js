...
function FireView(Imports) {
	...
	var scope = $("<img src=\"assets/images/spartanStrike_scope.png\">")
	...
	var bigRedButton = $("<img src=\"assets/images/spartanStrike_redButton.png\">")
	.css("position", "absolute")
	.css("width", width * .6)
	.css("left", width * .2)
	...
	var backButton = $("<img src=\"assets/images/spartanStrike_mapViewIcon.png\">")
	.css("position", "absolute")
